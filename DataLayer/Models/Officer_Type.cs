...
namespace DataLayer.Models
{
    ...
    public partial class Officer_Type
    {
        public int AY_OFFICER_TYPE_ID { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_OFFICER_TYPE { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_OFFICERTY_TEXT { get; set; }
