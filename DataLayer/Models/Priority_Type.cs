...
namespace DataLayer.Models
{
    ...
    public partial class Priority_Type
    {
        public int AY_PRIORITY_TYPE_ID { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_PRIORITY_TYPE { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_PRIORITYTY_TEXT { get; set; }
