...
namespace DataLayer.Models
{
    ...
    public partial class Legal_Persons
    {
        public int AY_Legal_Persons_Id { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_LEGPER_TYPE { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_LEGPERTY_TEXT { get; set; }
