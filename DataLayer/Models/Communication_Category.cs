...
namespace DataLayer.Models
{
    ...
    public partial class Communication_Category
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public Communication_Category()
        {
            this.Communication_Type = new HashSet<Communication_Type>();
        }
    
        public int AY_COMMUNICATION_CATEGORY_ID { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_COMM_CAT { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_COMMCAT_TEXT { get; set; }
