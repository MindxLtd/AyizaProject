...
namespace DataLayer.Models
{
    ...
    {
        public int AY_Identification_Type_Id { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_IDENT_TYPE { get; set; }
        public string AY_F_IDENTITY_TYPE { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_IDENTITYTY_TEXT { get; set; }
