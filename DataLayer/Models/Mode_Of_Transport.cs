...
namespace DataLayer.Models
{
    ...
    public partial class Mode_Of_Transport
    {
        public int AY_Mode_Of_Transport_ID { get; set; }
        public Nullable<int> AY_ENV_ID { get; set; }
        public string AY_F_MOT_TYPE { get; set; }
        public Nullable<int> AY_F_LANG_ID { get; set; }
        public string AY_F_LANG_CODE { get; set; }
        public string AY_F_MOTTY_TEXT { get; set; }
