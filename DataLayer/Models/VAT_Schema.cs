...
namespace DataLayer.Models
{
    ...
    public partial class VAT_Schema
    {
        ...
        public int AY_F_VAT_Schema_Id { get; set; }
        ...
        public Nullable<int> AY_Frequency_Id { get; set; }
        public string AY_F_VATSCH_TEXT { get; set; }
        public string AY_F_CASH_BASIS { get; set; }
        public string AY_F_ACCRUAL_BASIS { get; set; }
